...
class USBDriveCreator(Subcommand):
    """
    Generate an image for a bootable USB stick and flash it to some  a OS so it can operate as a stiefel-server.
    """
    ...
    def run(self, args, cfg):
        """
        create a bootable USB stick for starting stiefel-client.
        """
